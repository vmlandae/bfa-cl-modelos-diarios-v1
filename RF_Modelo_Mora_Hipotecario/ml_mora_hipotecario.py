...
def ejecutar_modelo(fecha_proceso: datetime.datetime) -> bool:
    """
    Función principal que ejecuta todo el flujo del modelo de mora hipotecario.
    ...
    try:
        ...
        if interfaz_de_datos_hipotecario_t.empty:
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("ERROR: No se proporcionó fecha. Uso: python ml_mora_hipotecario.py YYYY-MM-DD")
        sys.exit(1)
