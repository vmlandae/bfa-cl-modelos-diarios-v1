# Flujo de Queries - RF_PLI_008_LimpiaFlujGobCLP

**Entry Point:** `RF_PLI_008_LimpiaFlujGobCLP`
...
flowchart TD
  ...
  %% Nodos
  RF_PLI_008_LimpiaFlujGobCLP["RF_PLI_008_LimpiaFlujGobCLP"]:::entryClass
...
🎯 **RF_PLI_008_LimpiaFlujGobCLP** (Type32)
