# Flujo de Queries - RF_PLI_000_Gener_CarteraInv

**Entry Point:** `RF_PLI_000_Gener_CarteraInv`
...
flowchart TD
  ...
  %% Nodos
  RF_PLI_000_Gener_CarteraInv["RF_PLI_000_Gener_CarteraInv"]:::entryClass
...
🎯 **RF_PLI_000_Gener_CarteraInv** (DDL)
